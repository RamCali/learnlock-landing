      ...
      <div className="relative w-full max-w-md mx-4 bg-white rounded-2xl shadow-2xl overflow-hidden animate-slideUp">
        ...
        <div className="relative p-8 text-center">
          ...
          <div className="flex gap-2 justify-center mb-6 flex-wrap">
            <button
              onClick={() => {
                const url = "https://www.learnlock.one";
                window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}`, '_blank', 'width=550,height=420');
              }}
              className="flex items-center gap-2 bg-[#1877F2] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#166fe5] transition-colors"
            >
            ...
            <button
              onClick={() => {
                const text = "I just signed up for LearnLock - an app that turns screen time into learning time for kids! Check it out:";
                const url = "https://www.learnlock.one";
                window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(url)}`, '_blank', 'width=550,height=420');
              }}
              className="flex items-center gap-2 bg-[#1DA1F2] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#1a8cd8] transition-colors"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-[#0077B5] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#006399] transition-colors"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
